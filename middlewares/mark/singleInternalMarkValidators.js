...
// marks validators
const singleInternalMarkValidators = [
    check('department')
        .trim()
        .isLength({ min: 3 })
...
const singleInternalMarksValidationHandler = (req, res, next) => {
...
module.exports = {
    singleInternalMarkValidators,
    singleInternalMarksValidationHandler
}